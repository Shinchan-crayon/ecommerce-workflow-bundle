# Ecommerce Workflow Bundle

This bundle packages the current ecommerce workflow into one agent-readable and user-readable bundle.

It is not a one-click automation package.
